...
//                  border-amazon-lightNavy bg-amazon-navy transition-colors"
//     >
//       {/* Header */}
...
//           </div>
//           <div>
//             <h3 className="text-lg font-bold text-amazon-textDark text-white">
//               Create New User
//             </h3>
//             <p className="text-sm text-amazon-textLight text-slate-400">
...
//                      text-slate-400 hover:bg-amazon-lightNavy transition"
//         >
...
//         <p className="text-xs text-amazon-textLight text-slate-400">
...
//       <label className="text-xs font-semibold uppercase tracking-[0.15em] text-amazon-textLight text-slate-400">
